      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="student_marks.php" class="list-group-item active"><span class="icon-book"></span> STUDENT MARKS</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-book"></span> STUDENT REPORTED MARKS</center></h3>
            </div>
