...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="admin.php">DASHBOARD</a> /  REGISTER TEACHER</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="register_teacher.php" class="list-group-item active"><span class="icon-group"></span> REGISTER TEACHER</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-group"></span> TEACHERS REGISTRATION FORM</center></h3>
            </div>
                   ...
                   if(isset($_POST['save_data']))
                   {
                     ...
                     $date = date("m/d/Y");
                      ...
                      if($age > $date){
                        ...
                        //Query
                        $query = mysql_query("INSERT INTO teacher_tb(firstname,lastname,gender,age,qualification,salary) VALUES('$fname','$lname','$gender','$age','$qualification','$salary')");
                        if($query)
                        {
                          echo "<div class='col-sm-12 alert alert-success'><center><span class='icon-ok'></span> Teacher has Successfully Saved in School Database</center></div>";
                          echo "<meta http-equiv='refresh' content='2;url=teacher_tb.php'>";
                        }
                        else
                        {
                          echo "<div class='col-sm-12 alert alert-success'><center><span class='icon-remove'></span> Failed to register Teacher in School Database</center></div>";
              ...
              <form role="form" method="post" action="" class="row" id="block-validate">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      <label for="text" class="control-label">First Name:</label>
                      <input type="text" class="form-control" id="required2" name="firstname" placeholder="First Name" required>
                    </div>
                      <div class="form-group">
