          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="event_result.php">EVENT RESULTS</a></li>
            ...
            <?php
              if(isset($_POST['post_message'])){
                if(!empty($_POST['message'])){
                  ...
                  $p_query = mysql_query("INSERT INTO `event_results`(`result`) VALUES ('$message')");
                  if($p_query){
                ...
                <div class="col-md-12">
                  <div class="panel-group">
                    <div class="panel panel-info">
                      <div class="panel-heading">Event Results (Ibyavuye m'unama)</div>
                      <div class="panel-body">
                        <?php
                          $d_p_query = mysql_query("SELECT * FROM event_results order by id desc limit 1");
                          while($d_p_row = mysql_fetch_array($d_p_query)){
                            echo"<p>".$d_p_row['result']."<br><br><span class='label label-success'>".$d_p_row['time']."</span><hr></p>";
                          }
                        ?>
                      </div>
                    </div>
