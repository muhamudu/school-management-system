        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-money"></span> NONE STAFF PAYMENT TABLE</center></h3>
            </div>
            <div class="panel-body">
              <p align="right">
                <a class="btn btn-primary" href="pay_nonstaff.php"><i class="icon-money"></i> Pay</a>
                   ...
                   <?php
                        ...
                        echo "
                         <tr>
                           ...
                           <td><center><a href=update_nonstaff_payment.php?id=".$row['id']."><span class='icon-edit'> Edit</span></a> | <a href=remove_nonstaff.php?id=".$row['id']."><font color='red'><span class='icon-trash'> Delete</span></font></a></center></td>
                         </tr>
                        ";
                        }
                    ?>
