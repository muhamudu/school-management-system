...
<body>
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="admin.php">DASHBOARD</a> / STUDENT CARD /</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-dashboard"></span> SAINT PHILIP STUDENT CARD</center></h3>
            </div>
            <div class="panel-body">
            <a class="btn" href="" id="print"><i class="icon-cloud-download"></i></a>
            <?php
                      ...
                      <div class="card-body">
                        <div class="row">
                          <div class="col-md-11"><img src="../img/sch_sign.PNG" style="width:75px; height:80px;">
                            ...
                            <h5 style="margin-top:0px; margin-left:188px; color:#0080FF; font-family: 'Times New Roman', Times, serif;">
                              <?php 
                                $year = date('Y');
                                echo "$year";
                             ?></h5>
