        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="dod.php" class="list-group-item active"><span class="icon-home"></span> HOME</a>
          ...
          <div class="col-md-9">
            <div class="panel panel-default" id="table-content">
              ...
              <div class="panel-body" style="font-size:12px;">
                <p align="right"><a href="get_std_list_dod.php" class="btn btn-primary"><i class="icon icon-print"></i> Print</a></p>
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-responsive table-hover" id="datatable" style="font-size:12px; width: 100%;">
                      <thead>
                        <tr>
                          <th>N<sup>o</sup></th>
                          <th>Image</th>
                            ...
                            <td>
                              <div class='dropdown'>
                                ...
                                <ul class='dropdown-menu'>
                                  <li><a href='conduct-dod.php?id=".$row['id']."'>Conduct</a></li>
                                  <li><a href='permission-reg.php?id=".$row['id']."'>Permission</a></li>
                                  <li><a href='punishment-reg.php?id=".$row['id']."'>Punishment</a></li>
                                </ul>
                              </div>
                            </td>
                          </tr>
