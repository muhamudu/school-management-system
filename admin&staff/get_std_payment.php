...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="secretary.php">HOME</a> / PAID STUDENT</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-pencil"></span> PRINT PAID STUDENT LIST</center></h3>
            </div>
            <div class="panel-body">
              <p align="right"><a href="paid_student.php" class="btn btn-danger">Back</a></p>

                <form method="post" action="print_std_paid.php" class="row">
                    <div class="col-md-6">
                        <div class="input-group">
