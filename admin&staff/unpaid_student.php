...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="secretary.php"> HOME</a> / UNPAID STUDENTS</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="unpaid_student.php" class="list-group-item active"><span class="icon-money"></span> UNPAID STUDENT</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-money"></span> UNPAID STUDENTS</center></h3>
            </div>
            <div class="panel-body">
              <p align="right"><a href="std_payment.php" class="btn btn-primary"><span class="icon-money"></span> Pay</a> 
              <a href="get_std_unpaid.php" class="btn btn-success"><span class="icon-print"></span> Print</a></p>
                          ...
                          if($balance > 0){
                            ...
                            echo "
                              ...
                              <tr>
                                ...
                                <a href=delete_std_unpayment.php?id=".$row['id']."><font color='red'><span class='icon-trash'> Delete</span></font></a></center></td>
                              </tr>
                            ";
                          }
