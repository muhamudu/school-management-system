...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="admin.php">DASHBOARD</a> / STUDENT REPORT CARDS  </li>
      </ol>
    </div>
  </section><!-- Section 1 -->
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="list-group">
            ...
            <a href="report_card.php" class="list-group-item active"><span class="icon-book"></span> STUDENT REPORT CARDS</a>
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-book"></span> STUDENT REPORT CARDS</center></h3>
            </div>
