...
<head>
  ...
  <link rel="stylesheet" href="assets/css/jquery.scrollpane.css" media="screen" foo="bar">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="secretary.php">HOME</a> /  SECRETARY PROFILE</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-user"></span> SECRETARY PROFILE</center></h3>
            </div>
            <div class="panel-body">
              <?php
               if (isset($_GET['save_update'])) {
                 ...
                 if($age > $date){
                   ...
                   $s_u_query = mysql_query("UPDATE `secretary_tb` SET `firstname`='$Newfirstname',`lastname`='$Newlastname',`email`='$email',`gender`='$gender',`age`='$age',`province`='$Newprovince',`district`='$Newdistrict',`sector`='$Newsector' WHERE id='$id'");
                   if($s_u_query){
              ...
              ?>
              <?php
                $query = mysql_query("SELECT * FROM secretary_tb WHERE email='$username'");
                $row = mysql_fetch_array($query);
              ?>
              <form class="form-inline row" action="" method="get" role="form">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" name="email" value="<?php echo $username; ?>" readonly>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="date" name="age" value="<?php echo $row[age]; ?>" required>
                  </div>
