        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-money"></span> TEACHERS PAYMENT FORM</center></h3>
            </div>
            <div class="panel-body">
                <?php 
                    if(isset($_POST['save_data'])){
                        ...
                        $querytr = mysql_query("INSERT INTO `teacher_payment`(`teacher_id`, `salary`, `paid_salary`, `date_paid`) VALUES ('$teacher_id','$teacher_salary','$paid_salary','$date_paid')");
                ...
                <form role="form" method="post" action="" class="row" id="block-validate">
                    ...
                    <div class="col-md-6">
                        ...
                        <select class="form-control" name="teacher_id" id="teacher_id" required>
                            ...
                            <?php
                                $seltr = mysql_query("SELECT * FROM teacher_tb");
                        ...
                        <select class="form-control" name="teacher_salary" required>
                            <option disabled selected>Select Teacher Salary</option>
                            <?php
                                $seltr = mysql_query("SELECT * FROM teacher_tb");
                                while ($fet = mysql_fetch_array($seltr)) {
