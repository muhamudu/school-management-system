          ...
          <div class="col-md-9">
            <div class="panel panel-default">
              <div class="panel-heading" id="main-bg-color">
                <h3 class="panel-title"><center><span class="icon-legal"></span> STUDENT PUNISHMENT</center></h3>
              </div>
              ...
              <div class="panel-body" style="font-size:12px;">
                  ...
                  <?php   
                    if(isset($_POST['save'])){
                        ...
                        $date = $_POST['date'];
                        $fault = $_POST['fault'];
                        $marks_cutted = $_POST['marks_cutted'];
                        $punishment = $_POST['punishment'];

                        $c_query = mysql_query("INSERT INTO `punishment_tb`(`std_id`, `class`, `date`, `fault`, `cutted_marks`, `punishment`) VALUES ('$std_id','$class','$date','$fault','$marks_cutted','$punishment')");

                        if($c_query){
                            echo"<div class='col-sm-12 alert alert-success'><center><span class='icon-ok'></span> Punishment has Successfully Saved!!</center></div>";
                        }
                        else{
                            echo"<div class='col-sm-12 alert alert-danger'><center><span class='icon-remove'></span> Punishment has failed to be Saved!!</center></div>";
                        }
                    }
                  ?>
                <form method="post" action="">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <input type="text" placeholder="Enter Fault" class="form-control" name="fault">
                            </div>

                            <div class="form-group">
                                <input type="number" placeholder="Enter Marks to be cutted" class="form-control" name="marks_cutted">
                            </div>
                        </div>
                        
                        <div class="col-md-4">
                            <div class="form-group">
                            <textarea class="form-control" name="punishment">Punishment</textarea>
                            </div>
                            <button type="submit" name="save" class="btn btn-success"><i class="icon-save"></i> Save Punishment</button>
                        </div>
                    <div>
                </form>
              </div><!-- ./End Panel Body -->
