          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="gallery_post.php">GALLERY</a></li>
              </ul>
              ...
              <?php
                if(isset($_POST['gallery_post'])){
                  ...
                  $post_query = mysql_query("INSERT INTO `gallery_tb`(`g_img`, `title`) VALUES ('$name','$title')");
                    ...
                    if(move_uploaded_file($_FILES['image_name']['tmp_name'], $location)){
                      echo "<div class='col-md-12 alert alert-success'><center><span class=' icon-cloud-upload'></span> Image has been Uploaded!!!</center></div>";
                        ...
                        echo "<div class='col-md-12 alert alert-danger'><center><span class='icon-remove'></span> An error has occurred in uploading image!!Image is too large</center></div>".mysql_error();
                    }
                }
              ...
              <div id="cambinet" class="row">
                <form method="post" action="gallery_post.php" enctype="multipart/form-data">
                  <div class="col-md-4">
                  ...
                  <div class="form-group">
                      <label for="pwd">Title:</label>
                        <input type="text" placeholder="Enter Image Title" name="title" class="form-control">
                    </div>

                    <button type="submit" name="gallery_post" class="btn btn-primary"><span class="icon-pencil"></span> POST</button>
                  </div>
                </form>

                <div class="col-md-12">
                    <div class="alert alert-success">
                        <strong>School Cambinet Posted</strong><hr>
                        <div class='row'>
                        <?php
                          $sel = mysql_query("SELECT * FROM gallery_tb ORDER BY id ASC ");
                          while($sel_query = mysql_fetch_array($sel) )
                          {
                             echo "
                                ...
                                <div class='col-md-3'>
                                  ...
                                  <img style='width:100%;' src='uploaded-img/".$sel_query['g_img']."' />
                                  <h5 align='center'><b>".$sel_query['title']."</b></h5>
                                  <a href=remove_image.php?id=".$sel_query['id']." class='btn btn-success btn-xs btn-block'><i class='icon-trash'></i> Remove</a>
                                  </div>
