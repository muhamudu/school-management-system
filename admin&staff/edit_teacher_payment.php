...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="admin.php">DASHBOARD</a> /  TEACHER PROFILE</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-group"></span> TEACHER PROFILE AND PAYMENT</center></h3>
            </div>
            <div class="panel-body">
                <?php
                  $id=$_REQUEST['id'];
                  $sel=mysql_query("SELECT * FROM teacher_payment WHERE id='$id'");
                ...
                <?php
                    if(isset($_GET['save_update'])){
                        $id = $_GET['id'];
                        $Newpay_salary = $_GET['Newpay_salary'];

                        $query = mysql_query("UPDATE teacher_payment SET paid_salary='$Newpay_salary' WHERE id='$id'");
                        if ($query) {
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="firstname" value="<?php echo $fettr[firstname]; ?>" disabled>
                    </div>
                      <div class="form-group">
                      <label for="text">Last Name:</label>
                      <input type="text" class="form-control" name="lastname" value="<?php echo $fettr[lastname]; ?>" disabled>
                    </div>
                      <div class="form-group">
                      <label for="text">Gender:</label>
                      <input type="text" name="gender" class="form-control" value="<?php echo $fettr[gender]; ?>" disabled>
                    </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="qualification" class="form-control" value="<?php echo $fettr[qualification]; ?>" disabled>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="email" class="form-control" value="<?php echo $fettr[email]; ?>" disabled>
                    </div>

                    <div class="form-group">
                      <label for="pwd">Date Paid:</label>
                      <input type="text" name="Newsalary" class="form-control" value="<?php echo $row[date_paid]; ?>" disabled>
                    </div>

                    <div class="form-group">
                      <label for="pwd">Salary:</label>
                      <input type="text" name="Newsalary" class="form-control" value="<?php echo $row[salary]; ?>" disabled>
                    </div>
                    <div class="form-group">
                      <label for="pwd">Paid Salary:</label>
                      <input type="text" name="Newpay_salary" class="form-control" value="<?php echo $row[paid_salary]; ?>">
                    </div>
