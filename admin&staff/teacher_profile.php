...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="teacher.php">HOME</a> /  TEACHER PROFILE</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-user"></span> TEACHER PROFILE</center></h3>
            </div>
            <div class="panel-body">
              <?php
               if (isset($_GET['save_update'])) {
                 ...
                 $a_u_query = mysql_query("UPDATE `teacher_tb` SET `firstname`='$Newfirstname',`lastname`='$Newlastname',`email`='$email',`gender`='$gender',`age`='$age',`province`='$Newprovince',`district`='$Newdistrict',`sector`='$Newsector' WHERE id='$id'");
                 if($a_u_query){
              ...
              ?>
              <?php
                $query = mysql_query("SELECT * FROM teacher_tb WHERE email='$username'");
