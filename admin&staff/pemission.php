        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="pemission.php" class="list-group-item active"><span class="icon-book"></span> PERMISSION</a>
          ...
          <div class="col-md-9">
            <div class="panel panel-default" id="table-content">
              <div class="panel-heading" id="main-bg-color">
                <h3 class="panel-title"><center><span class="icon-list-alt"></span> STUDENT PERMISSION LIST</center></h3>
              </div>
              ...
              <div class="panel-body" style="font-size:12px;">
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover" id="datatable" style="font-size:12px;">
                    ...
                    <?php
                        $query = mysql_query("SELECT * FROM permission_tb");
                        $count = 0;
                        ...
                        <tr>
                            ...
                            <td>".$row['class']."</td>
                            <td>".$row['date_time_left']."</td>
                            <td>".$row['date_time_return']."</td>
                            <td>".$row['place']."</td>
                            <td>".$row['reason']."</td>
                            <td><center><a href=print_permision_report.php?id=".$row['id']."><font color='blue'><span class='icon-print'> Print</font></span></a> | <a href=delete_student_permission.php?id=".$row['id']."><font color='red'><span class='icon-trash'> Delete</font></span></a></center></td>
                        </tr>
                        ";
                        }
                    ?>
