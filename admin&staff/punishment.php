        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="punishment.php" class="list-group-item active"><span class="icon-book"></span> PUNISHMENT</a>
            </div>
          ...
          <div class="col-md-9">
            <div class="panel panel-default" id="table-content">
              <div class="panel-heading" id="main-bg-color">
                <h3 class="panel-title"><center><span class="icon-list-alt"></span> STUDENT PUNISHMENT LIST</center></h3>
              </div>
              ...
              <div class="panel-body" style="font-size:12px;">
                <div class="table-responsive">
                  <table class="table table-striped table-bordered table-hover" id="datatable" style="font-size:12px;">
                    ...
                    <?php
                        $query = mysql_query("SELECT * FROM punishment_tb");
                        $count = 0;
                        ...
                        <tr>
                            ...
                            <td>".$row['date']."</td>
                            <td>".$row['fault']."</td>
                            <td>".$row['cutted_marks']." marks</td>
                            <td>".$row['punishment']."</td>
                            <td><center><a href=delete_student_punishment.php?id=".$row['id']."><font color='red'><span class='icon-trash'> Delete</font></span></a></center></td>
                        </tr>
                        ";
                        }
                    ?>
