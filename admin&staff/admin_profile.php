...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="admin_profile.php"><font color="orange" size="+1"><b><?php echo $username; ?></b></font></a></li>
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="admin.php">DASHBOARD</a> /  ADMIN PROFILE</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-user"></span> HEADMISTRESS PROFILE</center></h3>
            </div>
            <div class="panel-body">
              <?php
               if (isset($_GET['save_update'])) {
                 ...
                 $a_u_query = mysql_query("UPDATE `admin` SET `firstname`='$Newfirstname',`lastname`='$Newlastname',`email`='$email',`gender`='$gender',`age`='$age',`province`='$Newprovince',`district`='$Newdistrict',`sector`='$Newsector' WHERE id='$id'");
                 if($a_u_query){
