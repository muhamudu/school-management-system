...
<nav class="navbar navbar-inverse navbar-fixed-top">
  ...
  <section id="breadcrumb">
    <div class="container">
      <ol class="breadcrumb">
        <li class="active"><a href="admin.php">DASHBOARD</a> / TEACHERS</li>
      </ol>
    </div>
  </section><!-- Section 1 -->
        ...
        <div class="col-md-9">
          <div class="panel panel-default">
            <div class="panel-heading" id="main-bg-color">
              <h3 class="panel-title"><center><span class="icon-list-alt"></span> TEACHER LIST</center></h3>
            </div>
            <div class="panel-body">
              <p align="right"><a href="print_teacher_list.php" class="btn btn-primary"><i class="icon-print"></i> Print</a>
              <a href="pay_teacher.php" class="btn btn-default"><i class="icon-money"></i> Pay</a></p>
              <div class="table-responsive">
                <table id="datatable" class="table table-striped table-bordered table-hover" style="font-size:12px;">
                   ...
                   <?php
                        $query = mysql_query("SELECT * FROM teacher_tb  ORDER BY firstname ASC");
                        $count = 0;
                        ...
                        echo "
                         <tr>
                           ...
                           <td><center><a href=edit_teacher.php?id=".$row['id']."><span class='icon-edit'> Edit</span></a> | <a href=delete_teacher_tb.php?id=".$row['id']."><span class='icon-trash'> <font color='red'>Delete</font></span></a></center></td>
                         </tr>
                        ";
                        }
                    ?>
