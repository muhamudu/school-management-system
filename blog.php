...
<!-- Mirrored from showwp.com/demos/ws-garden/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jan 2018 15:08:30 GMT -->
<head>
...
<body>  
    ...
    <div id="wrapper">
        ...
        <section class="section darkbg fullscreen paralbackground parallax" style="background:url('upload/bj.jpg') center;" data-img-width="1688" data-img-height="1125" data-diff="600">
        ...
        <section class="section white">
            <div class="container">
                <div class="row">
                    <div id="content" class="col-md-5 col-sm-12 col-xs-12">
                    ...
                    ?>
                        <div class="blog-wrapper">
                            <div class="blog-image">
                                <a href="blog_view.php?id=<?php echo $row['id']; ?>" title=""><img src="admin&staff/uploaded-img/<?php echo $row['blog_img']; ?>" alt="" class="img-responsive"></a>
                            </div><!-- end image -->
                            <div class="blog-title">
                                <a class="category_title" href="blog_view.php?id=<?php echo $row['id']; ?>" title=""><?php echo $row['title']; ?></a>
                                <h2><a href="blog_view.php?id=<?php echo $row['id']; ?>" title=""><?php echo $row['heading']; ?></a></h2>
                                <div class="post-meta">
                                    <span>
                                    ...
                                    <span>
                                    <i class="fa fa-eye"></i>
                                    <a href="#"><?php echo $row['count'] ?> Views</a>
                                    </span>
                                    <span>
                                ...
                                <p><?php echo $row['short_data']; ?></p>
                                <a href="blog_view.php?id=<?php echo $row['id']; ?>" class="readmore">Read more</a>
                            </div><!-- end desc -->
                        ...
                        <div class="widget">
                            ...
                            <div class="recent-post-widget">
                                <ul class="recent-posts">
                                    <?php 
                                        $query = mysql_query("SELECT * FROM blog_post ORDER BY id DESC LIMIT 20");
                                        while ($row = mysql_fetch_array($query)) {
                                    ?>
                                    <li>
