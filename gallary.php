...
<!-- Mirrored from showwp.com/demos/ws-garden/gallery-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jan 2018 15:09:09 GMT -->
<head>
...
<body>  
    ...
    <div id="wrapper">
                                        ...
                                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                                            <div class="navbar-cell">
                                                <ul class="nav navbar-nav navbar-right">
                                                    ...
                                                    <li><a href="gallary.php" class="active"><i class="fa fa-camera"></i> Gallary</a></li>
        ...
        <section class="section darkbg fullscreen paralbackground parallax" style="background:url('upload/bj.jpg') bottom;" data-img-width="1793" data-img-height="1125" data-diff="600">
        ...
        <section class="section white nopadbot">
            <div class="container-full">
                <div class="text-center clearfix">
                    <nav class="portfolio-filter wow fadeInUp">
                        <ul>
                            <li><a href="#"><i class="fa fa-filter"></i> All Images in Gallery</a></li>
                        </ul>
                    </nav>
                </div><!-- end text-center --> 
                ...
                <div class="portfolio wow fadeInUp">
                    ...
                    <?php
                        $query = mysql_query("SELECT * FROM gallery_tb ORDER BY id DESC");
                        while ($row = mysql_fetch_array($query)) {
                    ?>
                    <div class="pitem entry item-w1 item-h2 cat1">
                        <img src="admin&staff/uploaded-img/<?php echo $row['g_img']; ?>" alt="" class="img-responsive">
                        <div class="magnifier">
                            <div class="buttons">
                                <a data-rel="prettyPhoto" href="<?php echo"admin&staff/uploaded-img/".$row['g_img'].""; ?>" class="st" rel="bookmark"><span class="fa fa-search"></span></a>
                            </div>
                        </div><!-- end magnifier -->
                    </div>
